const conditions = [
...

  {
    ...
    attribute: {
      ...
      apiPath: 'projectManage/projectList',
      filter: ''
    }
  },

  {
    ...
    attribute: {
      ...
      fieldId: 'id',
      tableId: '1740772218121938036',
      apiPath: 'team/teamMember',
      filter: "{'columnName':'tenant.id, queryType: '=' value': currentUser.tenant.id}"
    }
  },
